...
${$$result.head += `<!-- HEAD_svelte-1336hm3_START -->${$$result.title = `<title>Blog category - page ${escape(page)}</title>`, ""}<meta data-key="description"${add_attribute("name", siteDescription, 0)}><!-- HEAD_svelte-1336hm3_END -->`, ""}
